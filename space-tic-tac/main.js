//audio files load
var audio1 = new Audio("space-tic-tac/assets/mixkit-page-back-chime-1108.wav")
var audio2 = new Audio("space-tic-tac/assets/mixkit-cooking-stopwatch-alert-1792.wav")
var newGame = new Audio("space-tic-tac/assets/newGame.wav")
var gameDraw = new Audio("space-tic-tac/assets/gameDraw.wav")
var gameWin = new Audio("space-tic-tac/assets/win.wav");
...
var cross = "url(space-tic-tac/assets/moon.png)";
var zero = "url(space-tic-tac/assets/globe.png)";

//game draw assets
var ops1 = "url(space-tic-tac/assets/oops.png)";

//speaker on offf
var musicOn = "url(space-tic-tac/assets/music.png)";
var musicOff = "url(space-tic-tac/assets/musicOff.png)"

//replay image
var replay = "url(space-tic-tac/assets/replay.png)"
