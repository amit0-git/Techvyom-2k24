...
const arr = [["Pre Register", document.querySelector("#navWrap > div:nth-child(1) > img"), "https://forms.gle/RRmvdc5SVd9upHN78"], ["Events", document.querySelector("#navWrap > div:nth-child(3) > img"), "events.xml"], ["Rulebook", document.querySelector("#navWrap > div:nth-child(9) > img"), "assets/TECHVYOM RULEBOOK.pdf"], ["Gallery", document.querySelector("#navWrap > div:nth-child(7) > img"), "gallery.html"],["Home", document.querySelector("#navWrap > div:nth-child(5) > img"), "index.html"]]
var start = 0
