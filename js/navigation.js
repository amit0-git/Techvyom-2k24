...
const arr = [["Home", document.querySelector("#navWrap > div:nth-child(1) > img"), "#"], ["Events", document.querySelector("#navWrap > div:nth-child(3) > img"), "events.html"], ["Rulebook", document.querySelector("#navWrap > div:nth-child(9) > img"), "rulebook.html"], ["Gallery", document.querySelector("#navWrap > div:nth-child(7) > img"), "gallery.html"]]
var start = 0
